    ...
    while(!queue.isEmpty()){
        ...
        if (map[now.y][now.x].type == 1){
            for (var i = 0; i < 2; i++) {
                ...
                if (j == 1){
                    if (now.inDirection == 1)
                        outDirection = 1;
                    else if (now.inDirection == 4)
                        outDirection = 4;
                }
                else if (j == 2){
                    if (now.inDirection == 2)
                        outDirection = 2;
                    else if (now.inDirection == 8)
                        outDirection = 8;
                }
            ...
            for (var i = 0; i < 4; i++) {
                ...
                if (j == 1){
                    ...
                    if (now.inDirection == 4)
                        outDirection = 8;
                    else if (now.inDirection == 2)
                        outDirection = 1;
                }
                else if (j == 4){
                    if (now.inDirection == 2)
                        outDirection = 4;
                    else if (now.inDirection == 1)
                        outDirection = 8;
                }
                // console.log("outDirection", outDirection);
                // str = "outDirection" + outDirection + "\n";
